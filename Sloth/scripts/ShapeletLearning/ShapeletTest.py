...
path = '66_chlorineConcentration/TRAIN/dataset_TRAIN/tables/learningData.csv'
training = pd.read_csv(path, index_col = 0)
y_train = training['label'].values
training_path = '66_chlorineConcentration/TRAIN/dataset_TRAIN/timeseries'
X_train = []
...
path = '66_chlorineConcentration/TEST/dataset_TEST/tables/learningData.csv'
testing = pd.read_csv(path, index_col = 0)
y_test = pd.read_csv('66_chlorineConcentration/SCORE/targets.csv', index_col = 0).values.T[0]
testing_path = '66_chlorineConcentration/TEST/dataset_TEST/timeseries'
X_test = []
